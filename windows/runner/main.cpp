                      ...
                      _In_ wchar_t *command_line, _In_ int show_command)
{
  ...
  if (SendAppLinkToInstance(L"PXY"))
  {
    return EXIT_SUCCESS;
  }

  HANDLE hMutexInstance = CreateMutex(NULL, TRUE, L"PXYMutex");
  HWND handle = FindWindowA(NULL, "PXY");
  ...
  if (GetLastError() == ERROR_ALREADY_EXISTS)
  {
    ...
    if (window.SendAppLinkToInstance(L"PXY"))
    {
      return false;
    }
  ...
  if (!window.Create(L"PXY", origin, size))
  {
    return EXIT_FAILURE;
  }
